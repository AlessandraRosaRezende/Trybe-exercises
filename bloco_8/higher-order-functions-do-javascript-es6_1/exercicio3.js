...
const checaResposta = (correctAnswer, userAnswer) => {  
  if (correctAnswer === userAnswer.toLowerCase()) {        
    return true;
  }  
  return false;  
}
console.log(checaResposta(correctAnswer, userAnswer));

const checaResposta2 = (correctAnswer) => (userAnswer) => correctAnswer === userAnswer.toLowerCase();
console.log(checaResposta2(correctAnswer)(userAnswer));